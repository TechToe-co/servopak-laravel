        ...
        <div class="xl:col-span-5">
          ...
          <div class="flex pt-10">
            ...
            <div class="ps-5">
              ...
              <a class="text-gray text-xl" href="mailto:taimour@servopak.co"
                >taimour@servopak.co</a
              >
            </div>
          </div>
          <div class="flex pt-10">
            ...
            <div class="ps-5">
              ...
              <a class="text-gray text-xl" href="#"
                >Apt T1 6626 Ronald Rd MD Capitol Heights 20743</a
              >
            </div>
          </div>
        </div>
