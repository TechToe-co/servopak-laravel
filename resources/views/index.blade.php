  ...
  <body>
      ...
      <div class="shadow-sm border-[#cbc9c9]">
        <div class="grid grid-cols-1 xl:grid-cols-4 md:grid-cols-2 gap-10">
          <div class="text-center pb-10 px-5">
            <i
              class="fa-regular fa-file-lines text-5xl bg-white mb-5 border px-8 py-6 rounded-full text-center text-yellow mt-[-60px] hover:bg-yellow hover:text-black transition-all duration-300"
            ></i>
            <a href="#">
          ...
          <div class="text-center pb-10 px-5">
            <i
              class="fa-solid fa-warehouse mb-5 text-5xl bg-white border px-5 py-6 rounded-full text-center text-yellow mt-[-60px] hover:bg-yellow hover:text-black transition-all duration-300"
            ></i>
            <a href="#">
          ...
          <div class="text-center pb-10 px-5">
            <i
              class="fa-solid fa-chalkboard mb-5 text-5xl bg-white border px-6 py-6 rounded-full text-center text-yellow mt-[-60px] hover:bg-yellow hover:text-black transition-all duration-300"
            ></i>
            <a href="#">
          ...
          <div class="text-center pb-10 px-5">
            <i
              class="fa-solid fa-box text-5xl bg-white mb-5 border px-7 py-6 rounded-full text-center text-yellow mt-[-60px] hover:bg-yellow hover:text-black transition-all duration-300"
            ></i>
            <a class="" href="#">
    ...
    <div class="container mx-auto py-10 my-10 xl:px-40 px-5">
      <div class="grid">
        ...
        <h2
          class="text-3xl xl:text-5xl font-bold pt-5 xl:pb-32 pb-10 fira !leading-[1.3]"
        >
    ...
    <div class="container py-10 my-10 mx-auto xl:px-40 px-5">
      <div class="bg-[#000] py-10 text-white">
        <div
          class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-4 px-10 gap-5"
        >
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-20 px-10 py-10 my-10">
          ...
          <div class="relative">
            ...
            <div
              class="absolute bottom-14 left-10 bg-white text-black px-5 py-5 animate"
            >
    ...
    >
      <div class="container py-10 mx-auto xl:px-40 px-3">
        <div
          class="grid xl:w-2/4 w-full lg:absolute xl:right-5 xl:top-[35%] md:top-[30%] top-[10%]"
        >
