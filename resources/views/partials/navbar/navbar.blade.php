<div style="background-color: #1d232a">
  <div class="navbar nav container mx-auto xl:px-32 shadow-lg shadow-inherit" style="background-color: #1d232af0">
    <div class="navbar-start w-full flex justify-between items-center">
      ...
      <a href="index.html" class="text-4xl font-bold gap-2 nav-logo">
        <img src="img/logo.png" alt="" class="img-fluid w-60 pe-2 mt-1" />
      </a>
    </div>
