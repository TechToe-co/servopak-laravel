...
<html lang="en">
  ...
  <body>
    ...
    >
      <div class="container mx-auto">
        <div class="text-center py-32">
          <p class="text-6xl font-bold fira">News</p>
          <div class="flex justify-center pt-3">
            ...
            <p class="font-semibold">
              <i class="fa-solid fa-angle-right px-2"></i>News
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container mx-auto py-10 my-10 xl:px-40 px-5">
      <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 pt-14">
        <div>
          <a href="#">
          ...
          >
            <div class="pt-5 flex">
              <p class="font-semibold">
                <i class="fa-regular fa-user text-yellow pe-2"></i>TransitFlow
              </p>

              <div class="ps-10">
                <p class="font-semibold">
                  <i class="fa-solid fa-comments text-yellow pe-2"></i>220
                  Comments
                </p>
              </div>
            </div>
